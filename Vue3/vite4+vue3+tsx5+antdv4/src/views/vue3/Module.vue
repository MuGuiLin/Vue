<template>
    <section class="module" v-loading="loading">
        <a-button type="success">{{ nowTime }}</a-button>
        ...
        <a-button type="primary" @click="show = !show">Vue3瞬移组件&lt;teleport&gt;标签</a-button>
        <Alert v-if="show" />
...
import Alert from './src/Teleport.vue';
import Async from './src/Suspense.vue';
import AsyncAxios from './src/Suspense2.vue';
